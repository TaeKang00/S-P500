...
Order of operations:
  ...
  4. Append today's forward-PE to FwdPEHistory and update the 3y rolling avg.
  5. Refresh market-timing snapshot (SPY/VIX/F&G).
"""
...
def refresh_watchlist_details(db: Session, on_progress=None) -> dict:
    ...
    for i, item in enumerate(items):
        ...
        if detail.forward_eps and detail.trailing_eps and detail.trailing_eps != 0:
