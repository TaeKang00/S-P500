...
export function MarketTimingBar({ fullRefreshing, yfinanceBlocked, refreshTrigger }) {
  ...
  return (
    <div className="bg-ink-800/60 border-t border-line flex items-stretch overflow-x-auto text-xs">
      <div
        className="flex items-center gap-2 px-3 border-r border-line shrink-0"
        style={{ borderLeft: `2px solid ${grade.color}` }}
      >
      ...
      <div className="ml-auto flex items-center gap-4 pr-3">
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-xs text-muted hover:text-gray-200 px-2 py-1 transition-colors disabled:opacity-30 disabled:cursor-not-allowed whitespace-nowrap"
          >
